        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Logado com sucesso!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Erro ao sair, tente novamente');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " atualizado com sucesso"));
            }
...
var stripe = Stripe('pk_test_51LOn5hDbsFIoDeQWAPdcLJsH1ilhEir3AmJu0Qp1AJP8gWvjSvnKK5EeHcQCipT6RJwpBFSxQwmMLYsHtO1S2RBF00TRVCCeSM');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://127.0.0.1:3000/api/v1/bookings/checkout/".concat(tourId));
...
var leafletjs = document.getElementById('map');

if (leafletjs) {
  var locations = JSON.parse(leafletjs.dataset.locations);
